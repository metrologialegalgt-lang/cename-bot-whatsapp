...
(function () {
  ...
  var ESTILOS = [
    ...
    /* chispas del enchufe */
    /* chispas del enchufe: brotan siempre, sobre la posición de los rayos originales */
    ".chispas{position:absolute;left:0;top:0;width:100%;height:100%;pointer-events:none}",
    ".chispas::before{content:'';position:absolute;left:18.7%;top:52.4%;width:40%;height:33.9%;margin:-20% 0 0 -20%;",
    "border-radius:50%;background:radial-gradient(circle,rgba(111,230,245,.55) 0%,rgba(111,230,245,.18) 45%,rgba(111,230,245,0) 70%);opacity:.75}",
    ".chispas svg{position:absolute;fill:#8FF3FF;stroke:#0E7C8F;stroke-width:.7;stroke-linejoin:round;",
    "opacity:.85;filter:drop-shadow(0 0 3px #2FD3EA)}",
    ".chispas svg:nth-child(1){left:1.98%;top:40.13%;width:13.61%;height:14.18%;transform:rotate(-4deg)}",
    ".chispas svg:nth-child(2){left:16.65%;top:44.32%;width:12.00%;height:12.50%;transform:rotate(47deg)}",
    ".chispas svg:nth-child(3){left:18.19%;top:52.74%;width:12.78%;height:13.32%;transform:rotate(85deg)}",
    /* globo de saludo */
    ...
    ".mascota .chispas svg{animation:chispa 1.25s linear infinite}",
    ".mascota .chispas svg:nth-child(2){animation-duration:1.6s;animation-delay:.35s}",
    ".mascota .chispas svg:nth-child(3){animation-duration:1.05s;animation-delay:.7s}",
    ".mascota .chispas::before{animation:resplandor 1.7s ease-in-out infinite}",
    ".mascota:hover .chispas svg,.mascota:focus-visible .chispas svg,.mascota.saluda .chispas svg{animation-duration:.55s}",
    ".globo.entra{animation:entra .25s ease-out}}",
    "@keyframes chispa{0%{opacity:0;scale:.7}6%{opacity:1;scale:1.08}13%{opacity:.2}20%{opacity:1;scale:1}30%{opacity:0;scale:.85}100%{opacity:0}}",
    "@keyframes resplandor{0%,100%{opacity:.45}50%{opacity:1}}",
